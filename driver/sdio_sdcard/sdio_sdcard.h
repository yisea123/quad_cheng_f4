...
//卡,可能也会出错,出错就请降低时钟
#define SDIO_INIT_CLK_DIV        118 		//SDIO初始化频率，最大400Kh  
...
typedef struct
{
	uint8_t  ManufacturerID;       /*!< ManufacturerID  制造商ID*/
...
#define SDIO_CMD0TIMEOUT                ((uint32_t)0x00010000)	  //命令0超时时间
